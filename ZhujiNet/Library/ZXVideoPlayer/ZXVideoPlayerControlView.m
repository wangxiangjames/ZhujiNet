...
static const CGFloat kVideoControlBarHeight = 20.0 + 20.0;
...
- (void)layoutSubviews
{
    ...
    NSLog(@"layoutSubviews2:%@",NSStringFromCGRect([UIScreen mainScreen].bounds));
    ...
    self.timeLabel.frame = CGRectMake(CGRectGetMinX(self.fullScreenButton.frame)-70, CGRectGetHeight(self.bottomBar.bounds) - CGRectGetHeight(self.timeLabel.bounds) -18- 2.0, 75, CGRectGetHeight(self.timeLabel.bounds));
    
    self.progressSlider.frame = CGRectMake(CGRectGetMaxX(self.playButton.frame), 0, CGRectGetMinX(self.timeLabel.frame) - CGRectGetMaxX(self.playButton.frame), kVideoControlBarHeight);
