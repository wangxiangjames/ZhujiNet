...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ALiVideoRecorder/ALiVideoRecorder.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PhotoBrowser/PhotoBrowser.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SJPlaybackListController/SJPlaybackListController.framework"
